...
const sections = [
  {
    ...
    images: [
      ...
      // './images/make/rocks.jpg',
      './images/make/voltovbts2.jpg',
      // './images/make/voltovbts.jpg',
  ...
  },
  {
    ...
    content: `We host screenings on campus regularly, showcasing a wide range of films across genres, languages, and styles.`,
  ...
  },
  {
    ...
    content: `We write longform editorials and reviews on films. (it would be boring to put images of us writing so here are some other fun club photos)`,
