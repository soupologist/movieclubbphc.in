      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-left">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="https://instagram.com/movieclubbphc" target="_blank" className="hover:underline text-lg">
              @movieclubbphc
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="https://letterboxd.com/movieclubbphc" target="_blank" className="hover:underline text-lg">
              @movieclubbphc
            </Link>
          </div>
